...
import { Box, Button, Card, Container, Flex, Heading, Link, SimpleGrid, Tag, Text } from "@chakra-ui/react";
...
const Home: NextPage = () => {
  ...
  const {
    contract: featuredCourseContract
  } = useContract(MINTED_COURSE_CONTRACTS[0]);
        ...
        <Container minW={"100%"} p={10} h={"100vh"}>
            <Card p={10} mb={10}>
              <Flex flexDirection={"row"}>
                ...
                <Flex flexDirection={"column"} px={10} justifyContent={"space-between"}>
                  <Flex flexDirection={"row"} justifyContent={"space-between"} alignContent={"center"} my={4}>
                    <Box>
                  ...
                  <Box>
                    ...
                    <Box mt={4} w={"85%"}>
                      <Text fontSize={"xl"} fontWeight={"bold"}>Course Description:</Text>
                  ...
                  <Flex flexDirection={"row"} justifyContent={"flex-end"} mt={4}>
                    <Link 
                          href={`/course/${MINTED_COURSE_CONTRACTS[0]}`}
                          mr={4}
                      >
                          <Button
                              minW={"100%"}
